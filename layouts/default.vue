<template>
    <div class="page-wrapper" >
        <label class="swap swap-rotate fixed top-1 right-1 z-50">

            <!-- this hidden checkbox controls the state -->
            <input type="checkbox" value="" :checked="checkedDark" @click="changeColorMode"/>
...
onMounted(() => {
    checkedDark.value = colorMode.preference == 'dark'
})
</script>
